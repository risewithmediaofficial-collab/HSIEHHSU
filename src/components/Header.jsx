                ...
                <div key={item.path} className="relative group">
                  {item.isMega ? (
                    <>
                      ...
                      {/* Mega Dropdown Menu */}
                      <div className="absolute left-1/2 -translate-x-1/2 mt-1 w-[90vw] max-w-[1100px] bg-white shadow-2xl rounded-2xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 border border-slate-200 overflow-hidden flex">
                        {/* Sidebar */}
