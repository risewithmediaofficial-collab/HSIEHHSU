        ...
        <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2.5 bg-[#2b6caf]/20 text-[#1a365d] px-5 py-2 rounded-none text-xs font-bold border-l-4 border-[#1a365d] uppercase tracking-widest mb-10">
              <AutoAwesome className="w-4 h-4 text-[#2b6caf]" />
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                <h3 className="text-xl font-black text-[#1a365d] uppercase tracking-tight">Treatment Options</h3>
                {[
            ...
            <div className="bg-gradient-to-br from-[#f7f9fb]/50 to-white border border-[#d6e4f0] p-12 rounded-2xl shadow-sm">
              <div className="space-y-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-black text-[#1a365d] text-sm uppercase tracking-widest mb-1">Extended Life</h3>
                    <p className="text-[#1a365d]/80 text-sm font-medium">Significantly longer operational lifespan</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-black text-[#1a365d] text-sm uppercase tracking-widest mb-1">Enhanced Protection</h3>
                    <p className="text-[#1a365d]/80 text-sm font-medium">Superior durability and protection level</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-black text-[#1a365d] text-sm uppercase tracking-widest mb-1">Performance Boost</h3>
                    <p className="text-[#1a365d]/80 text-sm font-medium">Improved roller performance and reliability</p>
                  </div>
                </div>
                  ...
                  <div className="space-y-2">
                    {[
                      ...
                      <div key={idx} className="flex items-center gap-2">
                        ...
                        <span className="text-[#1a365d]/80 text-sm">{benefit}</span>
                      </div>
                    ))}
                  </div>
                </div>
