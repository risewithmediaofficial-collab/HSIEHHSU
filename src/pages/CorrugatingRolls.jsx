  ...
  const materialContent = [
    {
      ...
      icon: <Shield className="w-8 h-8 text-[#2b6caf]" />
    },
    {
      ...
      icon: <Zap className="w-8 h-8 text-[#2b6caf]" />
    }
  ];
  ...
  const features = [
    {
      ...
      icon: <Target className="w-6 h-6 text-[#2b6caf]" />
    },
    {
      ...
      icon: <Shield className="w-6 h-6 text-[#2b6caf]" />
    },
    {
      ...
      icon: <Zap className="w-6 h-6 text-[#2b6caf]" />
    },
    {
          ...
          <div className="grid lg:grid-cols-2 gap-24 items-center">
            <div className="space-y-12">
               <div className="space-y-4">
                  <h2 className="text-4xl font-black text-[#1a365d] uppercase tracking-tighter">High-Performance Roller Core Systems</h2>
            ...
            <div className="relative aspect-square bg-[#f7f9fb]/40 border border-[#d6e4f0] flex items-center justify-center group overflow-hidden">
              ...
              <div className="absolute inset-x-0 bottom-0 z-10 p-12 bg-linear-to-t from-[#f7f9fb] to-transparent">
                <p className="text-[#1a365d] text-2xl font-black uppercase tracking-tighter opacity-10">Advanced Hub</p>
               </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-px bg-[#f7f9fb] border border-[#d6e4f0]">
            {features.map((feature, idx) => (
              <div key={idx} className="bg-white p-12 space-y-8 group hover:bg-[#f7f9fb]/20 transition-colors">
                ...
                <div>
                   <h3 className="text-sm font-black text-[#1a365d] uppercase tracking-widest mb-4">{feature.title}</h3>
                   <p className="text-[#1a365d]/70 text-xs font-medium leading-relaxed uppercase">{feature.desc}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="grid lg:grid-cols-2 gap-24 items-center">
             <div className="space-y-12">
               <div className="space-y-4">
                  <h2 className="text-4xl font-black text-[#1a365d] uppercase tracking-tighter">Versatile Industry Applications Matrix</h2>
                  <div className="w-20 h-1 bg-[#2b6caf]"></div>
                </div>
                ...
                <div className="grid sm:grid-cols-2 gap-px bg-[#f7f9fb] border border-[#d6e4f0]">
                   {applications.map((app, idx) => (
                      <div key={idx} className="bg-[#f7f9fb]/40 p-6 flex items-center gap-4">
                         ...
                         <span className="text-[10px] font-black uppercase tracking-widest text-[#1a365d]">{app}</span>
                      </div>
                   ))}
                </div>
             </div>
      ...
      <section className="py-16 bg-[#f7f9fb]/40 border-y border-[#d6e4f0]">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="grid lg:grid-cols-2 gap-24 items-start">
            <div className="space-y-12">
               <div className="space-y-4">
                  <h2 className="text-4xl font-black text-[#1a365d] uppercase tracking-tighter leading-none">Material Composition & Coating</h2>
                  <div className="w-20 h-1 bg-[#2b6caf]"></div>
                </div>
                  ...
                  <div key={idx} className="notification-card bg-white p-0 overflow-hidden border-[#d6e4f0]">
                    ...
                    >
                      <div className="flex items-center gap-6">
                        ...
                        <div>
                          <h3 className="text-sm font-black text-[#1a365d] uppercase tracking-widest">{item.title}</h3>
                          <p className="text-[10px] font-black text-[#2b6caf] uppercase tracking-widest">{item.subtitle}</p>
                        </div>
                      </div>
                      <ChevronDown className={`w-5 h-5 transition-transform duration-500 ${activeMaterialTab === idx ? 'rotate-180 text-[#2b6caf]' : 'text-[#1a365d]/40'}`} />
                    </button>
                    ...
                    <div className={`transition-all duration-500 ease-in-out ${activeMaterialTab === idx ? 'max-h-300 opacity-100 p-10 pt-0' : 'max-h-0 opacity-0 overflow-hidden'}`}>
                      <div className="pt-10 border-t border-[#d6e4f0] space-y-10">
                        ...
                        <div className="grid md:grid-cols-2 gap-10">
                          <div className="space-y-4">
                             <h4 className="text-[10px] font-black text-[#1a365d] uppercase tracking-widest">Key Features</h4>
                             <ul className="space-y-3">
                               {item.highlights.map((h, i) => (
                                 <li key={i} className="flex items-center gap-3">
                                   <div className="w-1 h-1 bg-[#2b6caf]"></div>
                                   <span className="text-[10px] font-bold text-[#1a365d]/80 uppercase tracking-widest">{h}</span>
                                 </li>
                                ))}
                             </ul>
                          </div>
                          <div className="space-y-4">
                             <h4 className="text-[10px] font-black text-[#1a365d] uppercase tracking-widest">Advantages</h4>
                             <ul className="space-y-3">
                               {item.details.map((d, i) => (
                                 <li key={i} className="flex items-center gap-3">
                                   <div className="w-1 h-1 bg-[#2b6caf]"></div>
                                   <span className="text-[10px] font-bold text-[#1a365d]/80 uppercase tracking-widest">{d}</span>
                                 </li>
                               ))}
                             </ul>
                          </div>
                        ...
                        <div className="bg-[#1a365d] p-8 text-white relative group overflow-hidden">
                           <p className="text-[10px] text-[#d6e4f0] font-black uppercase tracking-widest mb-2">Hsieh Hsu Performance Guarantee</p>
                           <p className="text-xs font-medium uppercase leading-relaxed text-[#d6e4f0]/80">Maximum cost-effectiveness and engineering precision.</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="pt-10 border-t border-[#d6e4f0]">
                    <div className="grid grid-cols-2 gap-12">
                      <div className="space-y-1">
                        ...
                        <div className="text-[#1a365d]/60 text-[10px] font-black uppercase tracking-widest leading-none">Chrome Thickness</div>
                      </div>
                      <div className="space-y-1">
                        <div className="text-[#1a365d] text-3xl font-black tracking-tighter italic">RA &lt; 0.2</div>
                        <div className="text-[#1a365d]/60 text-[10px] font-black uppercase tracking-widest leading-none">Surface Finish</div>
                      </div>
                    </div>
                  </div>
               </div>
          ...
          <div className="grid gap-4">
            {faqs.map((faq, idx) => (
              ...
              >
                ...
                >
                  <span className={`text-sm font-black uppercase tracking-widest leading-tight transition-colors ${openFaq === idx ? 'text-[#2b6caf]' : 'text-[#1a365d]'}`}>
                    {idx + 1}. {faq.q}
                  </span>
