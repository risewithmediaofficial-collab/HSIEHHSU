  ...
  const features = [
    {
      ...
      icon: <Layout className="w-6 h-6 text-[#2b6caf]" />
    },
    {
    ...
    },
    {
      ...
      icon: <Wrench className="w-6 h-6 text-[#2b6caf]" />
    }
  ];
    ...
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="order-2 lg:order-1 space-y-10">
              ...
              <div className="p-10 bg-[#f7f9fb]/40 border border-[#d6e4f0] relative group">
                <div className="space-y-4">
                  <h3 className="text-xl font-black text-[#1a365d] uppercase tracking-tighter">Established Excellence</h3>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div className="space-y-10">
              ...
              <div className="space-y-8">
                <div className="flex items-start gap-6 group">
                  ...
                  <div>
                    <h4 className="text-sm font-black text-[#1a365d] uppercase tracking-widest mb-2">Machine Width</h4>
                    <p className="text-[#1a365d]/70 text-xs font-medium leading-relaxed">1800 MM / 2200 MM / 2500 MM machine width options.</p>
                  </div>
                </div>
                <div className="flex items-start gap-6 group">
                  <div className="w-12 h-12 bg-[#f7f9fb]/40 border border-[#d6e4f0] flex items-center justify-center flex-shrink-0 group-hover:border-[#2b6caf] transition-colors">
                    <Zap className="w-6 h-6 text-[#1a365d]" />
                  </div>
                  <div>
                    <h4 className="text-sm font-black text-[#1a365d] uppercase tracking-widest mb-2">Versatility</h4>
                    <p className="text-[#1a365d]/70 text-xs font-medium leading-relaxed">Seamlessly switch between standard and customized board specifications.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#1a365d] p-12 text-white border border-[#1a365d] relative group">
              <h3 className="text-sm font-black uppercase tracking-widest mb-8 text-[#d6e4f0]">Core Specifications</h3>
      ...
      <section className="py-16 bg-[#f7f9fb]/40 border-t border-[#d6e4f0]">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl text-center space-y-10">
          <div className="space-y-4">
            <h2 className="text-4xl md:text-5xl font-black text-[#1a365d] uppercase tracking-tighter">Need HHC-300 Details?</h2>
            <div className="w-20 h-1 bg-[#2b6caf] mx-auto"></div>
          </div>
