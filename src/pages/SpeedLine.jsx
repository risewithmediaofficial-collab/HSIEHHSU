  ...
  const features = [
    {
      ...
      icon: <Cpu className="w-6 h-6 text-[#1F7A8C]" />
    },
    {
    ...
    },
    {
      ...
      icon: <Gauge className="w-6 h-6 text-[#1F7A8C]" />
    },
    {
    ...
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="order-2 lg:order-1 space-y-10">
              ...
              <div className="p-10 bg-[#E1E5F2]/40 border border-[#E1E5F2] relative group">
                <div className="space-y-4">
                  <h3 className="text-xl font-black text-[#022B3A] uppercase tracking-tighter">Large Scale Precision</h3>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div className="space-y-10">
              ...
              <div className="space-y-8">
                <div className="flex items-start gap-6 group">
                  ...
                  <div>
                    <h4 className="text-sm font-black text-[#022B3A] uppercase tracking-widest mb-2">Monthly Output</h4>
                    <p className="text-[#022B3A]/70 text-xs font-medium leading-relaxed">7000 MT/month depending on machine width.</p>
                  </div>
                </div>
                <div className="flex items-start gap-6 group">
                  <div className="w-12 h-12 bg-[#E1E5F2]/40 border border-[#E1E5F2] flex items-center justify-center flex-shrink-0 group-hover:border-[#1F7A8C] transition-colors">
            ...
            <div className="bg-[#022B3A] p-12 text-white border border-[#022B3A] relative group">
              <h3 className="text-sm font-black uppercase tracking-widest mb-8 text-[#BFDBF7]">System Specifications</h3>
      ...
      <section className="py-16 bg-[#E1E5F2]/40 border-t border-[#E1E5F2]">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl text-center space-y-10">
          <div className="space-y-4">
            <h2 className="text-4xl md:text-5xl font-black text-[#022B3A] uppercase tracking-tighter">Need HHC-350 Details?</h2>
            <div className="w-20 h-1 bg-[#1F7A8C] mx-auto"></div>
          </div>
