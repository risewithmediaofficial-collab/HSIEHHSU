        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                <h3 className="text-xl font-black text-[#022B3A] uppercase tracking-tight">Our Refurbish Process</h3>
                {[
            ...
            <div className="space-y-6">
              <div className="relative aspect-video bg-[#E1E5F2]/40 border border-[#E1E5F2] overflow-hidden group">
                <img 
              ...
              <div className="bg-gradient-to-br from-[#E1E5F2]/50 to-white border border-[#E1E5F2] p-8">
                <div className="grid sm:grid-cols-2 gap-6">
                  <div className="flex items-start gap-3">
                    <div className="w-10 h-10 rounded-full bg-[#1F7A8C] text-white flex items-center justify-center flex-shrink-0">
                      <Clock className="w-5 h-5" />
                    </div>
                    <div>
                      <h3 className="font-black text-[#022B3A] text-xs uppercase tracking-widest mb-1">Turnaround</h3>
                      <p className="text-[#022B3A]/80 text-xs">45-60 days</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h3 className="font-black text-[#022B3A] text-xs uppercase tracking-widest mb-1">Quality Assurance</h3>
                      <p className="text-[#022B3A]/80 text-xs">ISO Certified</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="py-16 bg-[#E1E5F2]/40 border-y border-[#E1E5F2]">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="text-center mb-16 space-y-4">
            <h2 className="text-4xl md:text-5xl font-black text-[#022B3A] uppercase tracking-tighter">Key Features & Benefits</h2>
