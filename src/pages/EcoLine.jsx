...
import { Settings, CheckCircle, Zap, Shield, TrendingUp, Users, Globe } from 'lucide-react';
import ecoLineImage from '../assets/ChatGPT Image Jun 11, 2026, 03_07_36 PM (1).png';
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="order-2 lg:order-1 space-y-10">
              <div className="space-y-4">
                ...
                <h2 className="text-4xl md:text-5xl font-black text-[#1a365d] uppercase tracking-tighter leading-none">
                  Invest in Growth
                </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            {features.map((feature, idx) => (
              <div key={idx} className="service-card p-10 flex flex-col items-center text-center">
                <div className="text-[#2b6caf] mb-8">{feature.icon}</div>
                <h3 className="text-sm font-black text-[#1a365d] uppercase tracking-widest mb-4 tracking-tight">{feature.title}</h3>
                <p className="text-[#1a365d]/70 text-[10px] leading-relaxed font-medium">{feature.desc}</p>
              </div>
            ))}
          </div>
        </div>
            ...
            <div className="space-y-10">
              ...
              <div className="space-y-8">
                <div className="flex items-start gap-6 group">
                  ...
                  <div>
                    <h4 className="text-sm font-black text-[#1a365d] uppercase tracking-widest mb-2">Local Support</h4>
                    <p className="text-[#1a365d]/70 text-xs font-medium leading-relaxed">Expert service teams available worldwide for immediate assistance and training.</p>
                  </div>
                </div>
                <div className="flex items-start gap-6 group">
                  <div className="w-12 h-12 bg-[#f7f9fb]/40 border border-[#d6e4f0] flex items-center justify-center flex-shrink-0 group-hover:border-[#2b6caf] transition-colors">
                  ...
                  <div>
                    <h4 className="text-sm font-black text-[#1a365d] uppercase tracking-widest mb-2">Full Maintenance</h4>
                    <p className="text-[#1a365d]/70 text-xs font-medium leading-relaxed">End-to-end lifecycle solutions ensuring your corrugator runs at peak efficiency.</p>
                  </div>
                </div>
              </div>
            </div>

            <div className="bg-[#1a365d] p-12 text-white border border-[#1a365d] relative group">
              <h3 className="text-sm font-black uppercase tracking-widest mb-8 text-[#d6e4f0]">Technical Spec</h3>
              <ul className="space-y-6">
                {[
                  ...
                  <li key={i} className="flex items-center gap-4">
                    ...
                    <span className="text-xs font-black uppercase tracking-widest text-[#d6e4f0]">{item}</span>
                  </li>
                ))}
              </ul>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl text-center space-y-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              ...
              className="px-12 py-4 border-2 border-[#2b6caf] text-[#2b6caf] text-xs font-black uppercase tracking-[0.2em] hover:bg-[#2b6caf] hover:text-white transition-all"
            >
              Apply Now
            </Link>
          </div>
