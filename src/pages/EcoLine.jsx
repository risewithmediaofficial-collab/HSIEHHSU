          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="order-2 lg:order-1 space-y-10">
              ...
              <p className="text-[#4a4a4a] leading-relaxed text-lg font-medium">
                Are you looking to invest in a potential market? The HHC-200 from Hsieh Hsu India meets the needs of manufacturers with a monthly output of 2,500 to 3,000 tons and performs even under challenging production conditions.
              </p>
              ...
              <div className="p-10 bg-[#fafafa] border border-[#eee] relative group">
                <div className="space-y-4">
                  ...
                  <p className="text-[#7a7a7a] text-sm leading-relaxed font-medium italic">
                    "The HHC-200 – delivering peak reliability even under difficult production conditions."
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="order-1 lg:order-2">
              <div className="relative aspect-square bg-[#fafafa] border border-[#eee] flex items-center justify-center group overflow-hidden">
                ...
                <div className="absolute top-6 left-6">
                  <span className="bg-[#1a1a1a] text-white px-6 py-2 text-[10px] font-black uppercase tracking-widest">1,800 mm Width</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="bg-[#1a1a1a] p-12 text-white border border-[#1a1a1a] relative group">
              <h3 className="text-sm font-black uppercase tracking-widest mb-8 text-[#f44336]">Technical Advantages</h3>
