  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          ...
          <div className="mb-16 overflow-x-auto lg:overflow-visible pb-4 lg:pb-8">
            <div className="relative w-full lg:flex lg:items-center lg:justify-between px-4 sm:px-6 lg:px-0">
              ...
              <div className="absolute left-0 right-0 top-10 h-1 bg-[#1a365d] -translate-y-full hidden lg:block" style={{zIndex: 0}}></div>
                  ...
                  <div key={index} className="relative flex flex-col items-center gap-3 flex-1" style={{minWidth: 'fit-content'}}>
                    ...
                    >
                      ...
                      <div className={`absolute inset-0 rounded-full transition-all duration-300 ${
                        selectedService === index
                          ? 'bg-[#1a365d]/0'
                          : 'bg-[#1a365d]/0 group-hover:bg-[#1a365d]/10'
                      }`}></div>
                    </button>
                    ...
                    <div className="text-center">
                      <p className={`text-[10px] sm:text-xs font-black uppercase tracking-widest transition-all duration-300 whitespace-nowrap px-1 ${
                        selectedService === index 
                          ? 'text-[#1a365d] font-black scale-105' 
                          : 'text-[#1a365d]/80 group-hover:text-[#2b6caf]'
                      }`}>
                        {service.title}
                      </p>
                    </div>
            ...
            <div className="grid lg:grid-cols-3 gap-0">
              ...
              <div className="lg:col-span-2 p-8 lg:p-12 border-r border-[#d6e4f0]">
                ...
                <div className="flex items-start gap-4 mb-6">
                  <div className="text-[#2b6caf]">
                    {rollerServices[selectedService].icon}
                  </div>
                  <div>
                    <h3 className="text-2xl lg:text-3xl font-black text-[#1a365d] uppercase tracking-tighter mb-2">
                      {rollerServices[selectedService].title}
                    </h3>
                    <div className="inline-flex items-center gap-2 text-[#2b6caf] text-xs font-black uppercase tracking-widest">
                ...
                <p className="text-[#1a365d]/80 leading-relaxed mb-8 text-sm lg:text-base">
                  {rollerServices[selectedService].description}
                </p>

                <div>
                  <h4 className="font-black text-[#1a365d] text-sm uppercase tracking-widest mb-4">What's Included:</h4>
                  <div className="space-y-3">
                    {rollerServices[selectedService].features.map((feature, idx) => (
                      <div key={idx} className="flex items-center gap-3">
                        ...
                        <span className="text-[#1a365d]/80 text-sm">{feature}</span>
                      </div>
                    ))}
                  </div>
                </div>
              ...
              {/* Right Outcome Box */}
              <div className="bg-[#1a365d] text-white p-8 lg:p-12 flex flex-col justify-center">
                <div className="space-y-8">
                  <div>
                    <div className="flex items-center gap-2 mb-3">
                      <TrendingUp className="w-5 h-5 text-[#d6e4f0]" />
                      <h4 className="font-black text-sm uppercase tracking-widest text-[#d6e4f0]">Expected Outcome</h4>
                    </div>
                    <p className="text-base lg:text-lg leading-relaxed text-[#d6e4f0]">
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-3">
                      <span className="text-xs font-black uppercase tracking-widest text-[#d6e4f0]">Progress</span>
                      <span className="text-xs font-black text-[#d6e4f0]">{selectedService + 1}/{rollerServices.length} Services</span>
                    </div>
                    <div className="w-full h-2 bg-[#2b6caf]/50 rounded-full overflow-hidden">
                      <div 
                        className="h-full bg-[#2b6caf] transition-all duration-500"
                  ...
                  <div className="space-y-3">
                    <Link
                      ...
                      className="block w-full bg-[#2b6caf] text-white px-6 py-3 text-center font-black text-sm uppercase tracking-widest hover:bg-white hover:text-[#1a365d] transition-colors rounded"
                    >
                      Get Quote
                    </Link>
                    <Link
                      to={rollerServices[selectedService].path}
                      className="block w-full border border-[#d6e4f0]/50 text-[#d6e4f0] px-6 py-3 text-center font-black text-sm uppercase tracking-widest hover:bg-white hover:text-[#1a365d] transition-colors rounded"
                    >
                      View Details
                    </Link>
                  </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="text-center mb-16 lg:mb-20 space-y-4">
            <h2 className="text-4xl md:text-5xl font-black text-[#2b6caf] uppercase tracking-tighter text-center">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            {supportServices.map((service, index) => (
              <div key={index} className="service-card p-6 flex flex-col items-center text-center bg-white border border-[#d6e4f0] hover:border-[#2b6caf] transition-all rounded-xl group overflow-hidden shadow-sm">
                 ...
                 <h3 className="text-sm font-black text-[#1a365d] uppercase tracking-widest mb-3">{service.title}</h3>
                 <p className="text-[#1a365d]/70 text-xs leading-relaxed font-medium">{service.description}</p>
              </div>
            ))}
          </div>
          ...
          <div className="bg-white border border-[#d6e4f0] p-12 lg:p-16 relative overflow-hidden group rounded-xl shadow-sm">
            ...
            <div className="relative">
              <div className="absolute top-10 left-0 right-0 hidden lg:block h-1 bg-[#d6e4f0] z-0"></div>
                ...
                {processSteps.map((item, index) => (
                  <div key={index} className="relative flex flex-col">
                    ...
                    <div className="space-y-2 text-center">
                      <span className="text-xs font-black text-[#2b6caf] uppercase tracking-widest">{item.step}</span>
                      <h4 className="font-black text-[#1a365d] text-sm uppercase tracking-widest">{item.title}</h4>
          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div className="space-y-10">
              <div className="space-y-4">
                <h2 className="text-4xl md:text-5xl font-black text-[#2b6caf] uppercase tracking-tighter leading-none">
            ...
            <div className="lg:pl-12">
              <div className="relative aspect-square bg-[#f7f9fb]/40 border border-[#d6e4f0] flex items-center justify-center group overflow-hidden">
                ...
                />
                <div className="absolute inset-x-0 bottom-0 p-12 bg-gradient-to-t from-[#f7f9fb] to-transparent">
                  <p className="text-[#1a365d] text-2xl font-black uppercase tracking-tighter opacity-10">Precision Service</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="text-center mb-16 lg:mb-20 space-y-4">
            ...
            <div className="w-20 h-1 bg-[#2b6caf] mx-auto"></div>
            <p className="text-[#1a365d]/80 text-sm lg:text-base">Micro hardness exceeds 1250 Vickers (72 HRC) with superior wear resistance and tenacity</p>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="bg-white border border-[#d6e4f0] p-8 lg:p-12 rounded-xl shadow-sm">
              ...
              <p className="text-[#1a365d]/80 text-sm mb-6">For Single Facer Applications:</p>
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={idx} className="flex gap-3 p-3 bg-[#f7f9fb]/40 rounded-lg border-l-4 border-[#1a365d]">
                    <CheckCircle className="w-5 h-5 text-[#1a365d] flex-shrink-0 mt-0.5" />
                    <div>
                      <p className="font-black text-sm text-[#1a365d]">{product.label}</p>
                      <p className="text-xs text-[#1a365d]/80">{product.desc}</p>
                    </div>
                  </div>
                ))}
              </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
            {[
              ...
              <div key={idx} className="bg-gradient-to-br from-[#f7f9fb]/50 to-white border border-[#d6e4f0] p-8 lg:p-10 rounded-xl hover:shadow-lg transition-all duration-300">
                ...
                <p className="text-xs font-black text-[#1a365d] uppercase tracking-widest mb-3">{test.subtitle}</p>
                <p className="text-[#1a365d]/80 text-sm leading-relaxed">{test.description}</p>
              </div>
            ))}
          </div>

          {/* Process Highlight */}
          <div className="mt-16 bg-[#1a365d] text-white p-8 lg:p-12 rounded-2xl shadow-md">
            <div className="max-w-3xl">
              <h3 className="text-2xl lg:text-3xl font-black uppercase tracking-tighter mb-4 text-white">Production Excellence</h3>
              <p className="text-base leading-relaxed mb-6 text-[#f7f9fb]">
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                <div className="flex gap-3">
                  <TrendingUp className="w-6 h-6 flex-shrink-0 text-[#2b6caf]" />
                  <span className="font-bold text-white">Hot Coating Operations for uniform coverage</span>
                </div>
                <div className="flex gap-3">
                  <Zap className="w-6 h-6 flex-shrink-0 text-[#2b6caf]" />
