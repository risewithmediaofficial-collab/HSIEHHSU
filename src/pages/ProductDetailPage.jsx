    ...
    <>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="space-y-8">
              ...
              <p className="text-lg text-[#022B3A]/80 leading-relaxed font-medium">{product.summary}</p>

              <div className="space-y-4">
                <h3 className="text-xl font-black text-[#022B3A] uppercase tracking-tight">{product.detailsHeading}</h3>
                {product.details.map((item) => (
                  <div key={item} className="flex items-center gap-3">
                    <CheckCircle className="w-5 h-5 text-[#022B3A] flex-shrink-0" />
            ...
            <div className="bg-gradient-to-br from-[#E1DEE6]/50 to-white border border-[#E1DEE6] p-12 rounded-2xl shadow-sm">
              <div className="aspect-[4/3] border border-[#E1DEE6] bg-white flex items-center justify-center p-6 overflow-hidden rounded-xl">
                <img
      ...
      <section className="py-16 bg-[#E1DEE6]/40 border-y border-[#E1DEE6]">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="grid lg:grid-cols-2 gap-8">
            <div className="bg-white border border-[#E1DEE6] p-10 rounded-2xl shadow-sm">
              <div className="flex items-center gap-3 mb-8">
                <CheckCircle className="w-5 h-5 text-[#022B3A]" />
                <h2 className="text-2xl font-black text-[#022B3A] uppercase tracking-tighter">Features</h2>
              </div>
              <div className="space-y-4">
                {product.features.map((feature) => (
                  <div key={feature} className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-[#FFD601]"></div>
                    <span className="text-[#022B3A] text-sm font-bold uppercase tracking-widest">{feature}</span>
                  </div>
                ))}
              </div>
            </div>

            <div className="bg-[#022B3A] text-white p-10 rounded-2xl shadow-md">
              <div className="flex items-center gap-3 mb-8">
                <Settings className="w-5 h-5 text-[#FFD601]" />
              ...
              <div className="space-y-4">
                {product.specs.map((spec) => (
                  <div key={spec} className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-[#FFD601]"></div>
                    <span className="text-xs font-black uppercase tracking-widest text-[#E1DEE6]">{spec}</span>
                  </div>
                ))}
              </div>
            </div>
      ...
      <section className="py-16 bg-white border-t border-[#E1DEE6]">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl text-center space-y-10">
          <div className="space-y-4">
            <h2 className="text-4xl md:text-5xl font-black text-[#022B3A] uppercase tracking-tighter">Need {product.code} Details?</h2>
