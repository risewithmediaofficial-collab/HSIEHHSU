  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                <h3 className="text-xl font-black text-[#022B3A] uppercase tracking-tight">Plating Benefits</h3>
                {[
            ...
            <div className="bg-gradient-to-br from-[#E1E5F2]/50 to-white border border-[#E1E5F2] p-12 rounded-lg">
              <div className="space-y-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-black text-[#022B3A] text-sm uppercase tracking-widest mb-2">Industry Standard</h3>
                    <p className="text-[#022B3A]/80">Most widely used and trusted solution</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-black text-[#022B3A] text-sm uppercase tracking-widest mb-2">Corrosion Protection</h3>
                    <p className="text-[#022B3A]/80">Superior resistance to harsh conditions</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-black text-[#022B3A] text-sm uppercase tracking-widest mb-2">Performance Assured</h3>
                    <p className="text-[#022B3A]/80">Reliable performance for demanding operations</p>
                  </div>
                </div>

                <div className="pt-6 border-t border-[#E1E5F2]">
                  <p className="text-xs text-[#022B3A]/60 mb-4 uppercase font-black tracking-widest">Plating Specifications</p>
      ...
      <section className="py-16 bg-[#E1E5F2]/40 border-y border-[#E1E5F2]">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="text-center mb-16 space-y-4">
            <h2 className="text-4xl md:text-5xl font-black text-[#022B3A] uppercase tracking-tighter">Why Choose Hard Chrome?</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            {[
              ...
              <div key={idx} className="bg-white p-8 lg:p-10 rounded-lg border border-[#E1E5F2] hover:border-[#1F7A8C] hover:shadow-md transition-all duration-300">
                <h3 className="font-black text-[#022B3A] text-sm uppercase tracking-widest mb-4">{feature.title}</h3>
                <p className="text-[#022B3A]/80 text-sm leading-relaxed">{feature.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="text-center mb-16 space-y-4">
            <h2 className="text-4xl md:text-5xl font-black text-[#022B3A] uppercase tracking-tighter">Chrome vs Alternatives</h2>
            <div className="w-20 h-1 bg-[#1F7A8C] mx-auto"></div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              ...
              <div key={idx} className="bg-gradient-to-br from-[#E1E5F2]/50 to-white border border-[#E1E5F2] p-8 lg:p-12 rounded-lg">
                <h3 className="text-2xl font-black text-[#022B3A] uppercase tracking-tight mb-8">{item.title}</h3>
                <div className="space-y-4">
                  {item.points.map((point, pidx) => (
                    <div key={pidx} className="flex items-start gap-3">
                      <CheckCircle className="w-5 h-5 text-[#1F7A8C] flex-shrink-0 mt-0.5" />
                      <span className="text-[#022B3A]/80 font-medium">{point}</span>
                    </div>
                  ))}
                </div>
              </div>
