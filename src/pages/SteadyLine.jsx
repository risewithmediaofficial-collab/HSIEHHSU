        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div className="space-y-10">
              ...
              <div className="space-y-8">
                <div className="flex items-start gap-6 group">
                  ...
                  <div>
                    <h4 className="text-sm font-black text-[#1a365d] uppercase tracking-widest mb-2">Low Waste</h4>
                    <p className="text-[#1a365d]/70 text-xs font-medium leading-relaxed">Significantly reduced production scrap through optimized speed transitions.</p>
                  </div>
                </div>
                <div className="flex items-start gap-6 group">
                  <div className="w-12 h-12 bg-[#f7f9fb]/40 border border-[#d6e4f0] flex items-center justify-center flex-shrink-0 group-hover:border-[#2b6caf] transition-colors">
                  ...
                  <div>
                    <h4 className="text-sm font-black text-[#1a365d] uppercase tracking-widest mb-2">Fast Setup</h4>
                    <p className="text-[#1a365d]/70 text-xs font-medium leading-relaxed">Accelerated order transitions with constant speed maintenance.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#1a365d] p-12 text-white border border-[#1a365d] relative group">
              <h3 className="text-sm font-black uppercase tracking-widest mb-8 text-[#d6e4f0]">Technical Specifications</h3>
